...
rm -f /usr/bin/lock
rm -f /usr/bin/unlock
wget -q -O /usr/bin/lock "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/limit/user-lock.sh" && chmod +x /usr/bin/lock
wget -q -O /usr/bin/unlock "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/limit/user-unlock.sh" && chmod +x /usr/bin/unlock
if [ "${EUID}" -ne 0 ]; then
