...
wget -q -O /usr/bin/infosc "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/limit/info.sh" && chmod +x /usr/bin/infosc
...
wget -q -O /usr/bin/autoreboot "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/autoreboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/tendang.sh"
wget -q -O /usr/bin/clearlog "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/clearlog.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/running.sh"
...
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/test/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/test/menu-vmess.sh"
#wget -q -O /usr/bin/menu-socks "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-socks.sh"
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/test/menu-ss.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/test/menu-trojan.sh"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/issue.net"
wget -q -O /root/versi "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/versibasic"
wget -q -O /usr/bin/updatsc "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/menu/update.sh"
wget -q -O /usr/bin/menu-backup "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/menu-backup.sh"
wget -q -O /usr/bin/fix "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/cf.sh"
wget -q -O /usr/bin/setting "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/Themes/setting.sh"
wget -q -O /usr/bin/menu-ipsec "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/ipsec/menu-ipsec.sh"
wget https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/autoscript-ssh-slowdns-main/wslow.sh
