...
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/tes/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/mofukuy/Autoscript-by-azi/main/tes/menu-vmess.sh"
